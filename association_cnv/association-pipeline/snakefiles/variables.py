### Snakemake_workflows initialization #######################################
        #samplesmapfile = expand(config['data_conversion_path'] + '/' + '{prefix}' + '.cnv.map', prefix = cnv_prefix)
...
### reg frequency equal 1% of total population and high_freq 2% of random_controls
high_freq = "4"
random_controls = "200"
