...
- If any part of the code is changed the pipeline should be run again and it is also recommended to remove the output directories to generate results from scrath.
